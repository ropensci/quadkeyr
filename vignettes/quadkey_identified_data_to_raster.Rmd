...
knitr::include_graphics("workflow_raster.png")
```
...
Quadkey conversion in the vignette [`From a QuadKey to a Simple Features data.frame and other conversions`](https://fernandez-lab-wsu.github.io/quadkeyr/articles/quadkey_to_sf_conversion.html#caveats-when-converting-coordinates).
